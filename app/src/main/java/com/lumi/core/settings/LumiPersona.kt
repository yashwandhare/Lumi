...
/**
 * Lumi's system prompt: v1's persona and Dev B's boundary rules, merged.
 *
...
object LumiPersona {
    ...
    val CHAT: String =
        """
        You are Lumi, a private assistant running entirely on the user's phone. Nothing they tell you
        leaves the device.
