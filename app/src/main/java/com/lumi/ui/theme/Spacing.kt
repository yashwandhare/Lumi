...
val LocalLumiSpacing = staticCompositionLocalOf { LumiSpacing() }
...
object LumiSize {
     ...
     *
     * Smaller than [LumiSpacing.touchTarget] on purpose. The drawn circle is 42dp; the tappable
