...
/**
 * Trace's only database. Everything the user owns lives here and nowhere else.
 *
 ...
 *
 * There is no `User` table. Design Spec §17 lists one, but Trace is single-user with no
